...
test('Verify User is able to Cancel Master Quote from @ui', async ({ page, createCustomerPage,  classManagementPage, createNewQuotePage, customerPortfolioPage, logger, searchPage, request}) => {
