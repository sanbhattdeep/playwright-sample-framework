...
test('Verify user is able to amend the master policy @ui', async ({ page, createCustomerPage, classManagementPage, createNewQuotePage, customerPortfolioPage, logger }) => {
